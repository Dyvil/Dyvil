 ...
 * with the signature {@code static X apply([Y])}, where {@code Y} is the type of the array. Note that such a method is
 * automatically inserted by the <i>Dyvil Compiler</i> for any
 * {@code case class} that takes a single {@code [X]} parameter, as shown in the below example.
 * <p>
 * Example:
 * 
 * <pre>
