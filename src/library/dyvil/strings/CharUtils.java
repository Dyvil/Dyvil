...
public final class CharUtils
{
	...
	private static final char[]		LOWER_CONSONANTS	= {
			'b', 'c', 'd', 'f', 'g', 'h', 'j', 'k', 'l', 'm', 'n', 'p', 'q', 'r', 's', 't', 'v', 'w', 'x', 'y', 'z' };
	
	private static final char[]		UPPER_CONSONANTS	= {
			'B', 'C', 'D', 'F', 'G', 'H', 'J', 'K', 'L', 'M', 'N', 'P', 'Q', 'R', 'S', 'T', 'V', 'W', 'X', 'Y', 'Z' };
	
	private static final String[]	CONSONANTS			= {
			"bl", "br", "bs", "by", "ch", "ck", "cl", "cr", "ct", "db", "dl", "dn", "dr", "ds", "dt", "dy", "fl", "fr", "ft", "gh", "gl", "gn", "gr", "gs",
			"hd", "hl", "hr", "ht", "hy", "kl", "kn", "ks", "lc", "ld", "lf", "lk", "ls", "lt", "ly", "mb", "mn", "mp", "ms", "nc", "nd", "ng", "nk", "nl",
