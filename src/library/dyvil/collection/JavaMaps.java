...
public interface JavaMaps
{
	...
	static boolean $qmark$at(java.util.Map<?, ?> map, Object key)
	{
	...
	static boolean $qmark(java.util.Map<?, ?> map, Object key, Object value)
	{
	 ...
	 */
	@DyvilModifiers(Modifiers.INFIX)
	static boolean $qmark(java.util.Map<?, ?> map, Entry<?, ?> entry)
	{
	 ...
	 */
	@DyvilModifiers(Modifiers.INFIX | Modifiers.INLINE)
	static boolean $qmark$colon(java.util.Map<?, ?> map, Object value)
	{
	 ...
	 */
	@DyvilModifiers(Modifiers.INFIX | Modifiers.INLINE)
	static <K, V> V subscript(java.util.Map<K, V> map, Object key)
	{
		return map.get(key);
	}
	 ...
	 */
	@DyvilModifiers(Modifiers.INFIX | Modifiers.INLINE)
	static <K, V> void subscript_$eq(java.util.Map<K, V> map, K key, V value)
	{
		map.put(key, value);
	}
	 ...
	 */
	@DyvilModifiers(Modifiers.INFIX | Modifiers.INLINE)
	static <K, V> void $plus$eq(java.util.Map<K, V> map, Entry<? extends K, ? extends V> entry)
	{
	 ...
	 */
	@DyvilModifiers(Modifiers.INFIX | Modifiers.INLINE)
	static <K, V> void $plus$plus$eq(java.util.Map<K, V> map1, java.util.Map<K, V> map2)
	{
		map1.putAll(map2);
	}
	 ...
	 */
	@DyvilModifiers(Modifiers.INFIX | Modifiers.INLINE)
	static <K, V> void $minus$at$eq(java.util.Map<K, V> map, Object key)
	{
		map.remove(key);
	}
	 ...
	 */
	@DyvilModifiers(Modifiers.INFIX | Modifiers.INLINE)
	static <K, V> void $minus$eq(java.util.Map<K, V> map, Entry<?, ?> entry)
	{
	 ...
	 */
	@DyvilModifiers(Modifiers.INFIX)
	static <K, V> void $minus$colon$eq(java.util.Map<K, V> map, Object value)
	{
	 ...
	 */
	@DyvilModifiers(Modifiers.INFIX)
	static <K, V> void $minus$minus$eq(java.util.Map<K, V> map, java.util.Map<?, ?> remove)
	{
	 ...
	 */
	@DyvilModifiers(Modifiers.INFIX)
	static <K, V> void $minus$minus$eq(java.util.Map<K, V> map, java.util.Collection<?> remove)
	{
		for (Object e : remove)
		{
			map.remove(e);
	 ...
	 */
	@DyvilModifiers(Modifiers.INFIX | Modifiers.INLINE)
	static <K, V> void map(java.util.Map<K, V> map, BiFunction<? super K, ? super V, ? extends V> mapper)
	{
	 ...
	 */
	@DyvilModifiers(Modifiers.INFIX | Modifiers.INLINE)
	static <K, V> void mapEntries(java.util.Map<K, V> map, BiFunction<? super K, ? super V, ? extends Entry<? extends K, ? extends V>> mapper)
	{
	 ...
	 */
	@DyvilModifiers(Modifiers.INFIX | Modifiers.INLINE)
	static <K, V> void flatMap(java.util.Map<K, V> map, BiFunction<? super K, ? super V, ? extends Iterable<? extends Entry<? extends K, ? extends V>>> mapper)
	{
		java.util.Map<K, V> temp = new LinkedHashMap<>(map.size() << 2);
		for (java.util.Map.Entry<K, V> entry : map.entrySet())
		{
	 ...
	 */
	@DyvilModifiers(Modifiers.INFIX)
	static <K, V> void filter(java.util.Map<K, V> map, BiPredicate<? super K, ? super V> condition)
	{
	 ...
	 */
	@DyvilModifiers(Modifiers.INFIX)
	static <K, V> MutableMap<K, V> mutable(java.util.Map<K, V> map)
	{
	 ...
	 */
	@DyvilModifiers(Modifiers.INFIX)
	static <K, V> ImmutableMap<K, V> immutable(java.util.Map<K, V> map)
	{
		int len = map.size();
		switch (len)
		{
