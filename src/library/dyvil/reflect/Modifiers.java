...
public interface Modifiers
{
	 ...
	 * method generated by the compiler to support generics.
	 */
	...
	/**
	 * <i>Dyvil</i> {@code lazy} modifier. If a field is marked with this
	 * modifier, it will be evaluated every time it is demanded and is thus not
	 * saved in the memory. This behavior can be compared with a method without
	 * parameters. This modifier will be converted to the {@link lazy}
	 * annotation.
	 */
	...
	/**
	 * <i>Dyvil</i> {@code byref} modifier. This is used to mark that a
	 * parameter is Call-By-Reference. If a parameter doesn't have this flag, it
	 * is Call-By-Value. This modifier will be converted to the {@link byref}
	 * annotation.
	 */
