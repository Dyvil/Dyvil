 ...
 * enough, since it has to store all parameters to the inlined call into local variables first. A typical example for an
 * intrinsic method is the {@link dyvil.lang.Predef#$eq$eq(Object, Object) ==} operator.
 * <p>
